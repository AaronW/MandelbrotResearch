...
#define FALSE 0
#define TRUE 1
#define MAXITER 30000            // Maximum iteration count before point is determined to not escape.
#define NUM_THREADS 4           // Number of threads for my POSIX Threaded implementation.
#define RUNCOUNT 50             // Number of times to run each implementation for benchmarking purposes.
